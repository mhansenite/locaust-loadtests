#!/usr/bin/env python3
"""
GlobalProjects User - Standalone Version for Direct Execution
Can be run directly with: locust -f workflows/admin/global_projects_user.py

This is a self-contained version that includes all necessary dependencies.
Auto-generated from HAR file: HARFIles/RAW_HAR/GlobalProjects.har
"""
...
# =============================================================================
# WORKFLOW CLASS - GlobalProjectsUser
# =============================================================================
...
if __name__ == "__main__":
    ...
    """
    print(f"""
🚀 GlobalProjects Standalone Workflow

📋 Usage:
   locust -f workflows/admin/global_projects_user.py
...
📊 Example Commands:
   # Basic test
   locust -f workflows/admin/global_projects_user.py --headless --users=5 --spawn-rate=1 --run-time=30s

   # With specific CSV data
   export TEST_DATA_CSV=config/test_data_production.csv
   locust -f workflows/admin/global_projects_user.py --headless --users=3 --spawn-rate=1 --run-time=15s
