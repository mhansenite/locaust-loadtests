#!/usr/bin/env python3
"""
ThundercatsProject User - Auto-generated from HAR file
...
class ThundercatsProjectUser(AuthenticatedUser):
    """
    User focused on thundercatsproject activities.
    ...
    def pageload(self):
        ...
        with self.client.get(
            "/v2/projects?_rsc=jice2",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
                "Priority": "u=4",
                "RSC": "1",
                "Referer": f"https://thundercats.{DOMAIN_SUFFIX}",
        ...
        with self.client.get(
            "/v2/projects/timeline?_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=1&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=2&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=3&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=4&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=0&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=9&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=5&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=6&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/v2/projects?sortBy=7&sortOrder=asc&_rsc=1u9fv",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-Prefetch": "1",
        ...
        with self.client.get(
            "/project/0a770dc5-1cef-4538-9773-935db0345c31/plan?_rsc=uibmb",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
        ...
        with self.client.get(
            "/project/5a253507-1bec-4a02-ac70-e8365e6a9d46/plan?_rsc=uibmb",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
        ...
        with self.client.get(
            "/project/192a7fe7-07ba-4a8b-9f91-596d31c463fd/plan?_rsc=uibmb",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
        ...
        with self.client.get(
            "/project/7c235972-a318-430e-b83e-e0c4af6e616b/plan?_rsc=uibmb",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
        ...
        with self.client.get(
            "/project/7c23c5a2-fd66-4897-984d-98f3d2051885/plan?_rsc=uibmb",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
        ...
        with self.client.get(
            "/project/7c234694-12ec-4969-b402-727587b7463e/plan?_rsc=uibmb",
            headers={
                "Accept": "*/*",
                "Host": f"thundercats.{DOMAIN_SUFFIX}",
                "Next-Router-State-Tree": router_state_tree,
    ...
    def apicalls(self):
        ...
        with self.client.get(
            ...
            headers={
                ...
                "Origin": f"https://thundercats.{DOMAIN_SUFFIX}",
                "Priority": "u=4",
                "Referer": f"https://thundercats.{DOMAIN_SUFFIX}",
                "Sec-Fetch-Dest": "empty",
                "Sec-Fetch-Mode": "cors",
    ...
    def on_start(self):
        ...
        if DEBUG:
            print("🚀 ThundercatsProjectUser initialized and authenticated")
